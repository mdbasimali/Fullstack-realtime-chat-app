        ...
        <div className='max-w-md text-center space-y-6 z-10'>
            ...
            <div className='flex justify-center gap-4 mb-2'>
                <div className='relative'>
                    <div className='w-20 h-20 rounded-3xl bg-blue-50 dark:bg-blue-950/30 flex items-center justify-center border border-blue-100 dark:border-blue-900/30 shadow-sm animate-pulse'>
